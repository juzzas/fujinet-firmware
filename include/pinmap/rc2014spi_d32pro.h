...
/* SPI BUS interface */
#define PIN_BUS_DEVICE_CS       GPIO_NUM_34
#define PIN_BUS_DEVICE_MISO     GPIO_NUM_32
#define PIN_BUS_DEVICE_MOSI     GPIO_NUM_33
#define PIN_BUS_DEVICE_SCK      GPIO_NUM_25
